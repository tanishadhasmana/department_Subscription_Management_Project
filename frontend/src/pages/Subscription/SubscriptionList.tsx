...
const SubscriptionList: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      ...
      const columnMap: Record<string, string> = {
        subscName: "subsc_name",
        subscType: "subsc_type",
        subscPrice: "subsc_price",
        subscCurrency: "subsc_currency",
  ...
  const SortArrow = ({ column }: { column: string }) => {
    if (sortBy !== column)
      return (
        <span className="inline-block ml-2 opacity-50 select-none">▲▼</span>
      );
                ...
                <tr className="bg-gray-100">
                  ...
                  <th className="p-2">
                    <input
                      ...
                      value={searchValues.subscName}
                      onChange={(e) =>
                        setSearchValues((prev) => ({
                          ...prev,
                          subscName: e.target.value,
                        }))
                      }
                  ...
                  <th className="p-2">
                    <input
                      ...
                      value={searchValues.subscType}
                      onChange={(e) =>
                        setSearchValues((prev) => ({
                          ...prev,
                          subscType: e.target.value,
                        }))
                      }
                      className="w-full p-1 border rounded"
                    />
                  ...
                  <th className="p-2">
                    <input
                      ...
                      value={searchValues.subscPrice}
                      onChange={(e) =>
                        setSearchValues((prev) => ({
                          ...prev,
                          subscPrice: e.target.value,
                        }))
                      }
                      className="w-full p-1 border rounded"
                    />
                  ...
                  <th className="p-2">
                    <input
                      ...
                      value={searchValues.subscCurrency}
                      onChange={(e) =>
                        setSearchValues((prev) => ({
                          ...prev,
                          subscCurrency: e.target.value,
                        }))
                      }
                      className="w-full p-1 border rounded"
                    />
                ...
                {subscriptions.length === 0 ? (
                  ...
                  subscriptions.map((s, index) => (
                    <tr key={s.id} className="border-t hover:bg-gray-50">
                      ...
                      <td className="p-3 uppercase">{s.subsc_currency || "-"}</td>
                      ...
                      <td className="p-3 text-center space-x-3">
                        <button
                          onClick={() => nav(`/subscriptions/edit/${s.id}`)}
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              <Pagination
                ...
                onLimitChange={(newLimit) => {
                  ...
                  loadSubscriptions(column, value, 1, newLimit, sortBy, sortOrder);
                }}
              />
            </div>
          </>
...
//                     >
//                       Department <SortArrow column="department_id" />
//                     </button>
//                   </th>
//                   <th className="p-3 text-left">Status</th>
//                   <th className="p-3 text-center">Actions</th>
...
//                       </td>
//                       <td className="p-3">{s.subsc_name || "-"}</td>
//                       <td className="p-3">{s.subsc_type || "-"}</td>
//                       <td className="p-3">{s.subsc_price || "-"}</td>
//                       <td className="p-3">{s.subsc_currency || "-"}</td>
//                       <td className="p-3">{s.department_id || "-"}</td>
//                       <td className="p-3">
//                         <label className="relative inline-flex items-center cursor-pointer">
//                           <input
//                             type="checkbox"
//                             checked={s.subsc_status === "active"}
//                             onChange={(e) =>
//                               handleToggle(
//                                 s.id,
//                                 e.target.checked ? "active" : "inactive"
